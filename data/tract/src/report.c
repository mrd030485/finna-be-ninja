...
{                               /* --- create an item set reporter */
  ...
  size_t     len, sum, m;       /* length of an item name and sum */
...
void isr_direct (ISREPORT *rep, const ITEM *items, ITEM n,
...
void isr_directx (ISREPORT *rep, const ITEM *items, ITEM n,
                  const double *iwgts,
                  RSUPP supp, double wgt, double eval)
{                               /* --- report an item set */
  ITEM c;                       /* buffer for the item counter */
...
void isr_rule (ISREPORT *rep, const ITEM *items, ITEM n,
