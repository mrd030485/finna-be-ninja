...
namespace OrderTrackerv2.HOOemployees {
    ...
    public class ArtPendingData : DataSet {
        
        private OrdersDataTable tableOrders;
        
        public ArtPendingData() {
            this.InitClass();
        ...
        protected ArtPendingData(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            ArtPendingData cln = ((ArtPendingData)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "ArtPendingData";
            this.Prefix = "";
            this.Namespace = "http://www.tempuri.org/ArtPendingData.xsd";
        ...
        public class OrdersDataTable : DataTable, System.Collections.IEnumerable {
            ...
            public OrdersRow AddOrdersRow(int orderNumber, System.DateTime dueDate, int reorderNumber, System.DateTime artDueDate, string rushReorderRegular, string orderType, string customerNumber, bool artFinished, bool productionFinished, bool orderFinished) {
