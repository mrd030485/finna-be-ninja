<%@ Page language="c#" Codebehind="SearchContacts.aspx.cs" AutoEventWireup="false" Inherits="OrderTrackerv2.HOOemployees.SearchContacts" %>
...
<asp:DataGrid id=grdResults Runat="server" DataSource="<%# dsResults %>" DataMember="Order" CellPadding="4" AllowPaging="True">
					...
					<TD vAlign="top" width="50%"><asp:panel id="pnlSearch" runat="server">Search Contacts 
      <HR width="100%" SIZE="1">
