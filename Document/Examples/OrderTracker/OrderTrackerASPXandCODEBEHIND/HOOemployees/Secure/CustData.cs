...
namespace OrderTrackerv2.HOOemployees.Secure {
    ...
    public class CustData : DataSet {
        ...
        protected CustData(SerializationInfo info, StreamingContext context) {
        ...
        public override DataSet Clone() {
            CustData cln = ((CustData)(base.Clone()));
            cln.InitVars();
            return cln;
        }
        ...
        private void InitClass() {
            this.DataSetName = "CustData";
            this.Prefix = "";
            this.Namespace = "http://www.tempuri.org/CustData.xsd";
        ...
        public class CustomersDataTable : DataTable, System.Collections.IEnumerable {
            ...
            public CustomersRow AddCustomersRow(string SID, string name, string phone, string email) {
            ...
            public CustomersRow FindBySID(string SID) {
            ...
            private void InitClass() {
                this.columnSID = new DataColumn("SID", typeof(string), null, System.Data.MappingType.Element);
        ...
        public class CustomersRow : DataRow {
            ...
            public string SID {
                get {
                    return ((string)(this[this.tableCustomers.SIDColumn]));
                }
                set {
                    this[this.tableCustomers.SIDColumn] = value;
                }
            }
