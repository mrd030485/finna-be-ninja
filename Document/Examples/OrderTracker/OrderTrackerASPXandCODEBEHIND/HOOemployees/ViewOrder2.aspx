...
<%@ Page language="c#" Codebehind="ViewOrder2.aspx.cs" AutoEventWireup="false" Inherits="OrderTrackerv2.HOOemployees.Secure.ViewOrder2" %>
...
<HTML>
	...
	<body MS_POSITIONING="FlowLayout">
		<form id="Form1" method="post" runat="server">
			...
			<P><asp:hyperlink id="HyperLink1" runat="server">Add/Update Art Description</asp:hyperlink><br>
				<br>
			</P>
			<P>
			...
			<P>
				<TABLE id="tbOrderHeader2" cellSpacing="2" cellPadding="0" width="100%" border="0">
					<TR>
						...
						<TD colSpan="5"><asp:textbox id="txtCustomerName" runat="server" CssClass="TextBox" MaxLength="40" ReadOnly="True"></asp:textbox><asp:linkbutton id="searchForCustomer" runat="server" CausesValidation="False">Search for a Customer</asp:linkbutton><asp:requiredfieldvalidator id="RequiredFieldValidator2" runat="server" Display="None" ControlToValidate="txtCustomerName"
								ErrorMessage="A Customer is Required!"></asp:requiredfieldvalidator></TD>
					</TR>
					<TR>
						<TD bgColor="#ffffff">Contact Person:</TD>
						<TD bgColor="#ffffff" colSpan="5"><asp:textbox id="txtContactName" runat="server" CssClass="TextBox" MaxLength="40" ReadOnly="True"></asp:textbox><asp:linkbutton id="searchForContact" runat="server" CausesValidation="False">Search for a Contact</asp:linkbutton></TD>
					</TR>
					<TR>
						<TD>Address:</TD>
...
<asp:LinkButton id="LinkButton1" runat="server">Show Add Shirt Menu</asp:LinkButton>
<asp:panel id="pnlAddShirtMenu" runat="server" Visible="False" HorizontalAlign="Right">
						<TABLE id="Table3" cellSpacing="1" cellPadding="1" width="100%" border="0">
							...
							<TR>
								...
								<TD bgColor="#ffffff"></TD>
								<TD align="right" bgColor="#ffffff"><STRONG><FONT color="#ff0000"></FONT></STRONG></TD>
								<TD bgColor="#ffffff" colSpan="5"><FONT color="#ff0000"><STRONG></STRONG></FONT></TD>
								<TD align="right" bgColor="#ffffff" colSpan="3"><STRONG><FONT color="#ff0000">Unit Price:</FONT></STRONG></TD>
								<TD align="left" bgColor="#ffffff" colSpan="2">$
									<asp:TextBox id="txtUnitPrice" runat="server" CssClass="TinyTextBox">0</asp:TextBox><STRONG><FONT color="#ff0000"></FONT></STRONG></TD>
