<%@ Page language="c#" Codebehind="SearchOrder.aspx.cs" AutoEventWireup="false" Inherits="OrderTrackerv2.HOOemployees.SearchOrder" %>
...
<asp:DataGrid id=grdResults Runat="server" CellPadding="4" DataMember="Order" DataSource="<%# dsResults %>">
