package ca.pfv.spmf.frequentpatterns.fpgrowth_with_strings_saveToFile;
...
public class AlgoFPGrowth {
	...
	public void runAlgorithm(StringBuffer input, double minsupp) throws IOException {
		...
		scanDatabaseToDetermineFrequencyOfSingleItems(new StringReader(input.toString()), mapSupport);
	...
	private void scanDatabaseToDetermineFrequencyOfSingleItems(StringReader input,
